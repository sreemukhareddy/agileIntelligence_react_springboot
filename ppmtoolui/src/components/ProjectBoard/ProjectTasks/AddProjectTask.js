...
class AddProjectTask extends Component {
  ...
  onSubmit = (event) => {
    ...
    console.log(newTask);
    this.props.addProjectTaskAction(
...
const mapDispatchToProps = (dispatch) => {
  return {
    addProjectTaskAction: (backLogId, projectTask, history) =>
      dispatch(backLogActions.addProjectTask(backLogId, projectTask, history)),
